...
/* video : https://www.youtube.com/watch?v=LuLCLgMElus
    Approach : 1) find the element in array where arr[i] < arr[i+1] . keep that as i
    2) Step 2 - find the index(j) which is greater than arr[i]. and swap arr[i] and arr[j]
    3) reverse the array from (i+1) till (arr.length -1)
* */
